...
public:
	...
	static ScriptProgram* GetGlobalScriptProgram(fallout::Program* scriptPtr);

	static void AddTimerEventScripts(fallout::Program* script, long time, long param);
	static void RemoveTimerEventScripts(fallout::Program* script, long param);
	static void RemoveTimerEventScripts(fallout::Program* script);

	static int __stdcall ScriptHasLoaded(fallout::Program* script);
...
void __fastcall SetGlobalScriptRepeat(fallout::Program* script, int frames);
void __fastcall SetGlobalScriptType(fallout::Program* script, int type);
...
void __fastcall SetSelfObject(fallout::Program* script, fallout::Object* obj);
...
int RunScriptStartProc(fallout::GlobalScript* scr);
